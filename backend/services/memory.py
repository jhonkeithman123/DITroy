...
class SupabaseMemoryStore:
    """Supabase store scaffold prepared for future switch-over.

    This adapter validates Supabase configuration early and leaves method
    implementations explicit so migration is incremental and low-risk.
    """
